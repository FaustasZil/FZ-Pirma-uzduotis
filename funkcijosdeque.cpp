...
void fisvestis(std::deque <zmogus> temp, int vm, string vardas) {
...
void apskaiciavimas(std::deque <zmogus>& amas, std::deque <string>& ndskcc, int dydis) {
	//pradet skaiciuot
